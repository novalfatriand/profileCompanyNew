...
function buttonDesc() {
    p.innerHTML = 'Introducing Aerox Water Detector, your simple, quick, and accurate solution for locating ground water sources. Designed for ease of use and dependable performance perfect for homeowners, farmers, and small-scale explorers seeking to find groundwater sources with confidence. <br><br>Why choose Aerox Water Detector? <br>- 95% Accurate to find ground water source point <br>- One button operation to initiate ground water source detection <br>- Integrated LCD screen showing detected water source depth in meter <br>- Water quality differentiation <br>- Durable full metal construction <br>- Predict aquifer depth and thickness <br><br>Contact us for ordering: <br><br> <a href="https://wa.me/+6285190060033" class="focus:outline-none text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-normal rounded-md text-xs px-4 py-2 me-2 mb-2">WhatsApp</a><a href="https://www.facebook.com/share/sZC2RhDVAsGyGSAn/?mibextid=kFxxJD" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-normal rounded-md text-xs px-4 py-2 me-2 mb-2">Facebook</a>'
